...
The surface orientation can be set using the parameters \path{incOpt}, which automatically sets the inclination depending on the type of outer wall, and \path{aziOpt}, which automatically sets the azimuth.
