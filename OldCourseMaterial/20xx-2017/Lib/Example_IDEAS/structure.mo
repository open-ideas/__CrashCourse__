...
model Structure "Building envelope model"
  extends IDEAS.Interfaces.BaseClasses.Structure(final Q_design={north.Q_design,south.Q_design}, final nZones=2, final nEmb=0);
...
IDEAS.Buildings.Components.Zone south(                  V=39.2, nSurf=6,
    redeclare package Medium = Medium,
    A=11.88,
    n50=12) "south zone of office area"
...
equation
  ...
  connect(south_win.propsBus_a, south.propsBus[1]) annotation (Line(
      points={{6.3,-50},{6,-50},{6,-38},{60,-38},{60,-36.3333}},
      color={255,204,51},
      thickness=0.5,
      smooth=Smooth.None));
  connect(south_ext.propsBus_a, south.propsBus[2]) annotation (Line(
      points={{-33.7,-48},{-34,-48},{-34,-38},{36,-38},{36,-37},{60,-37}},
      color={255,204,51},
      thickness=0.5,
      smooth=Smooth.None));
