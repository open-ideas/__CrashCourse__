...
model Connected
  ...
  ClassesAndConnectors.Mass mass
    annotation (Placement(transformation(extent={{-70,30},{-50,50}})));
  ClassesAndConnectors.Mass mass1 annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={-20,30})));
  ClassesAndConnectors.Mass mass2 annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={20,30})));
  ClassesAndConnectors.Mass mass3
    annotation (Placement(transformation(extent={{70,30},{50,50}})));
  ClassesAndConnectors.Resistor resistor
    annotation (Placement(transformation(extent={{-50,30},{-30,50}})));
  ClassesAndConnectors.Resistor resistor1
    annotation (Placement(transformation(extent={{30,30},{50,50}})));
  ClassesAndConnectors.Resistor resistor2
