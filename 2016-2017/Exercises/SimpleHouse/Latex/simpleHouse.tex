...
surface area and we choose $h=2$W/mK.
...
The radiator has a nominal power of 3 kW 
for a temperature difference of 20 K between inlet and outlet
of the radiator.
...
wall is relatively well insulated (k=0.04)
...
We will implement a hysteresis controller with a set point of 295.15 +- 1 K (21-23 $^{\circ}$C).
